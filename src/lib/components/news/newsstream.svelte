<script>
	...
	onMount(() => {
		...
		news.forEach(item => {
            console.log(item.src); // Imprimir la ruta de la imagen en la consola
        });
...
<div class="tooltip" data-tip="Noticias">
	<h1>NOTICIAS</h1>
</div>
